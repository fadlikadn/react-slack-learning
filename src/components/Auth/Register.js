                ...
                <Grid.Column style={{ maxWidth: 450 }}>
                    ...
                    <Form onSubmit={this.handleSubmit} size="large">
                        <Segment stacked>
                            ...
                            <Form.Input fluid name="email" icon="mail" iconPosition="left" placeholder="Email" onChange={this.handleChange} value={email} type="email" className={this.handleInputError(errors, 'email')} />
